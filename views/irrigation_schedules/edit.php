...
<div class="container mx-auto">
    <h1 class="text-2xl font-bold mb-4">Edit Irrigation Schedule</h1>
    <form action="index.php?url=irrigationschedules/edit/<?php echo $data['schedule']->schedule_id; ?>" method="post">
